...
const ProjectListTest: React.FC<ProjectListProps>  = ({project}) => {
        ...
        try{
            ...
            for(const task of tasks){
                ...
                if(taskData && taskData.taskAssign.includes(memberToRemove)){
                    ...
                    const taskRefString = `project/${project.id}/category/${task.categoryId}/task/${task.taskId}`;
